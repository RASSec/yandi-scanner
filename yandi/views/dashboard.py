...
def view_dashboard():
    dashboard_data = {
        ...
        "githubcc_count": get_count()['github_count'],
        "emailcc_count": get_count()['email_count'],
    }
...
def get_count():
    ...
    count = {
        ...
        "github_count": connectiondb(subgithub_db).count(),
        "email_count": connectiondb(mail_db).count(),
