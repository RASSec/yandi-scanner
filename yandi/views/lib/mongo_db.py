...
def db_name_conf():
    ...
    github_db = app.config.get('GITHUB_DB')
    subgithub_db = app.config.get('SUBGITHUB_DB')
    ...
    mail_task_db = app.config.get('MAIL_TASK_DB')
    mail_db = app.config.get('MAIL_DB')
    todo_db = app.config.get('TODO_DB')
    ...
    db_name_dict = {
        ...
        'domain_db': domain_db,
        'github_db':github_db,
        'subgithub_db':subgithub_db,
        'weekpasswd_db': weekpasswd_db,
        'port_db': port_db,
        'auth_db': auth_db,
        'acunetix_db': acunetix_db,
        'mail_task_db': mail_task_db,
        'mail_db': mail_db,
        'todo_db': todo_db,
